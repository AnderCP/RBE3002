...
class Lab2:
    ...
    def __init__(self):
        ...
        rospy.init_node('lab2_previous', anonymous=True)
        ...
        self.arrive_status = rospy.Publisher('/arrival', PoseStamped, queue_size=10)
    ...
    def follow_path(self, plan):
        ...
        """
        self.arrived = False        # Has not arrived at goal
        rospy.loginfo("Following the path")
        
        waypoint = plan.poses       # Get the array of Poses
        ...
        self.arrive_status.publish(waypoint[-1])
    ...
    def driveToPoint(self, target_x, target_y, linear_speed):
        ...
        TOLERANCE_DIST = 0.07   # Tolerance in position ## 0.02  ## with the glitching it works with 0.1
    ...
    def drive(self, distance, linear_speed):
        ...
        TOLERANCE_DIST = 0.13    # Tolerance in position ## 0.02  ## with the glitching it works with 0.1
        TOLERANCE_ANGLE = 0.1   # Tolerance in angle for PID controller #0.01 ## with the glitching it works with 0.08
